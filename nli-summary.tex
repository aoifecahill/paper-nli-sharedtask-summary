...
in the shared task, as well as their abbreviations.  Sections~\ref{sec-results}
...
system on a combination of the training and development data.  In
...
of participating teams, along with their team abbreviations, can be
...
as well.  A summary of the machine learning methods is shown in Table~\ref{tab:common-machine-learning}.
