...
\shortcite{wong-dras:2011:EMNLP} explored the use of production rules
from two parsers and \shortcite{swanson-charniak:2012:ACL2012short} explored
the use of Tree Substitution Grammars (TSGs).  \shortcite{tetreault-EtAl:2012:PAPERS} also investigated the use of TSGs as well as dependency
features extracted from the Stanford parser.  

Other approaches to NLI have included the use of Latent Dirichlet Analysis
to cluster features \cite{}
...
presented in \cite{tetreault-EtAl:2012:PAPERS}, we used \textsc{toefl11}
