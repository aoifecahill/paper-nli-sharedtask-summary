...
as well as authorship profiling.  While there has been a growing body of 
work in NLI, it has been difficult to compare approaches as there have been issues
with the test corpora commonly used for this task, as well as 
little consistency in the reporting of results. In this shared task, the first
...
developed systems which were trained solely on TOEFL-TRAIN and TOEFL-DEV.  This 
...
data {\it except} for TOEFL-TRAIN and TOEFL-DEV.  Three teams competed in this
...
\end{tabular}
\end{small}
\caption{Machine Learning algorithms used in Shared Task\label{tab:common-features}}
\end{table*}
...
Need some sort of wrapup.  consider this a success?
