...
that there has been little consistency in the field in the use of cross-
validation, the number of L1s, and which L1s are used. As a result, comparing
one approach to another has been extremely difficult.
...
for this competition, thus facilitating direct comparison of approaches.
...
type of training data (as is done in \cite{brooke2011native}) {\em excluding} any data from the TOEFL11, but still evaluated on
TOEFL-TEST.
\item {\bf Open-Training-2}: The third task allowed the use of TOEFL11-TRAIN and TOEFL11-DEV combined with any other additional data. This most closely reflects a real-world scenario.
\end{itemize}
